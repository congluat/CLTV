		...
		<div class="col-md-6">
			...
			<div class="col-md-4">
				...
				<script>(function(d, s, id) {
				  ...
				  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.6&appId=1400518590255894";
				  fjs.parentNode.insertBefore(js, fjs);
				}(document, 'script', 'facebook-jssdk'));
				</script>
				<div class="fb-share-button" data-href="${link}" data-layout="button" data-mobile-iframe="true"></div>
			</div>
		</div>
	</div>
